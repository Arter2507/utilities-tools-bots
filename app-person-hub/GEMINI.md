...
> **QUAN TRỌNG:** Mọi quy tắc về lập trình, tổ chức file và quy trình làm việc đều được tập trung tại **[RULES.md](./RULES.md)**. Agent PHẢI đọc và tuân thủ file này.
...
## 🚀 Tối ưu hóa Token (Token Efficiency)
> **Dành cho Agent:** Trước khi thực hiện liệt kê toàn bộ thư mục bằng `list_dir` hoặc tìm kiếm sâu, hãy thực thi lệnh `/map` hoặc đọc trực tiếp file `MAP.md` tại thư mục Root. Đây là "bản đồ vàng" giúp bạn nắm bắt dự án chỉ với một lượng token tối thiểu.
